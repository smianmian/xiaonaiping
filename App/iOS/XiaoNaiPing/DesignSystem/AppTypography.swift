...
enum AppTypography {
    ...
    static let homeBabyName = Font.custom(handMedium, size: 27, relativeTo: .title)
    static let homeDay = Font.custom(handMedium, size: 18, relativeTo: .title3)
    static let homeSectionTitle = Font.custom(handMedium, size: 25, relativeTo: .title)
    static let homeCardTitle = Font.custom(handMedium, size: 17, relativeTo: .headline)
    static let homePrimaryData = Font.custom(handMedium, size: 22, relativeTo: .title2)
    static let homeListText = Font.custom(handMedium, size: 16, relativeTo: .body)
    static let homeSecondary = Font.custom(readableRegular, size: 15, relativeTo: .subheadline)
    static let stateLabel = Font.custom(readableRegular, size: 14, relativeTo: .subheadline)
    static let stateValue = Font.custom(handMedium, size: 20, relativeTo: .title3)
    static let quickSheetTitle = Font.custom(handMedium, size: 20, relativeTo: .title2)
    static let quickSheetCancel = Font.custom(handRegular, size: 15, relativeTo: .subheadline)
}
