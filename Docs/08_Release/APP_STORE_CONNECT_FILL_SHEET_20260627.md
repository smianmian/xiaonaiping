...
版本页、发布方式、出口合规、IDFA 和内容权利填写见 `Docs/08_Release/APP_STORE_VERSION_RELEASE_SETTINGS_20260627.md`。

最终人工粘贴、同轮 build / 证据截图核对见 `Docs/08_Release/APP_STORE_CONNECT_FINAL_ENTRY_AUDIT_20260627.md`。
...
以 `Docs/08_Release/APP_STORE_PRIVACY_LABEL.json` 为最终源文件。人工逐项核对表见 `Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260627.md`。当前摘要：
...
| 当前候选图 | 当前候选为 iPhone 17 Pro / 6.3" / 1206 x 2622 | 只作为 App Store Connect 文案和画面顺序候选；不能把 1206 x 2622 候选图声称为 6.9 英寸最终截图 |
...
- App Review Information 私密字段包：`Docs/08_Release/APP_STORE_REVIEW_INFORMATION_20260627.md`。
