...
源文件：`Docs/08_Release/APP_STORE_CONNECT_FILL_SHEET_20260704.md`

App Review Information 私密字段另见：`Docs/08_Release/APP_STORE_REVIEW_INFORMATION_20260704.md`

App Privacy 逐项答案表另见：`Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260704.md`

版本页和发布设置另见：`Docs/08_Release/APP_STORE_VERSION_RELEASE_SETTINGS_20260704.md`

结构化草稿总览另见：`Docs/08_Release/APP_STORE_CONNECT_DRAFT_20260704.json`

人工填写当天执行包另见：`Docs/08_Release/APP_STORE_CONNECT_ENTRY_SESSION_PACKET_20260704.json`

最终人工粘贴和同轮证据核对另见：`Docs/08_Release/APP_STORE_CONNECT_FINAL_ENTRY_AUDIT_20260704.md`
...
```text
逐项答案表：Docs/08_Release/APP_STORE_AGE_RATING_ANSWERS_20260704.md
...
逐项填写以 Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260704.md 为人工核对表。
