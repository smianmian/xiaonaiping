...
2. 如 App Store Connect 最终计算结果不是 `4+`，以 App Store Connect 结果为准，并同步 `APP_STORE_METADATA.md`、`APP_STORE_SUBMISSION_PACKET.md`、`APP_STORE_CONNECT_COPY_PASTE_20260703.md` 和 Review Notes。
