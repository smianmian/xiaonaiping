...
版本页、发布方式、出口合规、IDFA 和内容权利填写见 `Docs/08_Release/APP_STORE_VERSION_RELEASE_SETTINGS_20260630.md`。

结构化草稿总览见 `Docs/08_Release/APP_STORE_CONNECT_DRAFT_20260630.json`，该 JSON 只用于核对草稿字段，不代表可提交审核。

人工填写当天执行包见 `Docs/08_Release/APP_STORE_CONNECT_ENTRY_SESSION_PACKET_20260630.json`，该包只约束填写顺序、停机条件、页面证据和复跑命令，不代表 App Store Connect 已填写或可提交审核。

最终人工粘贴、同轮 build / 证据截图核对见 `Docs/08_Release/APP_STORE_CONNECT_FINAL_ENTRY_AUDIT_20260630.md`。
...
以 `Docs/08_Release/APP_STORE_PRIVACY_LABEL.json` 为最终源文件。人工逐项核对表见 `Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260630.md`。当前摘要：
...
- App Review Information 私密字段包：`Docs/08_Release/APP_STORE_REVIEW_INFORMATION_20260630.md`。
