...
| What's New | 第一版：宝宝档案、日常记录、成长记录、疫苗提醒、照片时间线、手机号/微信/恢复密钥账号同步恢复和云端账号删除。 |
| Promotional Text | 用低负担的方式记录喂养、睡眠、排便、成长、疫苗提醒和珍贵照片。 |
| Description | 复制 `Docs/08_Release/APP_STORE_CONNECT_COPY_PASTE_20260628.md` 的描述 |
...
| Evidence | `Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260628.md` 和 `App/iOS/XiaoNaiPing/PrivacyInfo.xcprivacy` |
