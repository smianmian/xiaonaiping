...
源文件：`Docs/08_Release/APP_STORE_CONNECT_FILL_SHEET_20260628.md`

App Review Information 私密字段另见：`Docs/08_Release/APP_STORE_REVIEW_INFORMATION_20260628.md`

App Privacy 逐项答案表另见：`Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260628.md`

版本页和发布设置另见：`Docs/08_Release/APP_STORE_VERSION_RELEASE_SETTINGS_20260628.md`

结构化草稿总览另见：`Docs/08_Release/APP_STORE_CONNECT_DRAFT_20260628.json`

人工填写当天执行包另见：`Docs/08_Release/APP_STORE_CONNECT_ENTRY_SESSION_PACKET_20260628.json`

最终人工粘贴和同轮证据核对另见：`Docs/08_Release/APP_STORE_CONNECT_FINAL_ENTRY_AUDIT_20260628.md`
...
数据默认本地优先保存。开启账号与同步后，可通过恢复密钥、手机号或微信登录私有账号，并将记录和主动加入 App 的照片原图同步到账号空间，便于换机恢复。
...
- 账号与同步：支持恢复密钥、手机号、微信登录、云端同步恢复和账号删除。
...
```text
第一版：宝宝档案、日常记录、喝奶提醒、成长记录、疫苗提醒、照片时间线、手机号/微信/恢复密钥账号同步恢复和云端账号删除。
```

## 年龄分级填写口径

```text
逐项答案表：Docs/08_Release/APP_STORE_AGE_RATING_ANSWERS_20260628.md
...
逐项填写以 Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260628.md 为人工核对表。
