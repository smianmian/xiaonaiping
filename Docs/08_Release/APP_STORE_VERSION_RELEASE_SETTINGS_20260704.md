...
| Description | 复制 `Docs/08_Release/APP_STORE_CONNECT_COPY_PASTE_20260704.md` 的描述 |
...
| Evidence | `Docs/08_Release/APP_STORE_PRIVACY_ANSWERS_20260704.md` 和 `App/iOS/XiaoNaiPing/PrivacyInfo.xcprivacy` |
