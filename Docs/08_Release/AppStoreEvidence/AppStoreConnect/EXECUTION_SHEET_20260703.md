...
- `../../APP_STORE_CONNECT_FILL_SHEET_20260703.md`
- `../../APP_STORE_CONNECT_COPY_PASTE_20260703.md`
- `../../APP_STORE_SUBMISSION_PACKET.md`
- `../../APP_STORE_CONNECT_FINAL_ENTRY_AUDIT_20260703.md`
...
| --- | --- | --- | --- | --- |
| `ASC-01-app-information.png` | App Information | App 名称、小奶瓶、Bundle ID、SKU、主类别、版权、隐私政策 URL、技术支持 URL、用户协议 URL | Apple ID 邮箱、完整手机号、付款信息、D-U-N-S 编码完整值 | 字段和 `APP_STORE_CONNECT_COPY_PASTE_20260703.md` 一致 |
