...
当前不得直接提交。先按 `Docs/08_Release/CHINA_MAINLAND_LAUNCH_GAP_ASSESSMENT.md` 完成主体、备案、域名、华为云中国大陆生产环境、儿童与敏感个人信息、照片原图云备份和远程验证证据，再开放中国大陆 App Store。
